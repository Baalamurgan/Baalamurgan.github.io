            ...
            <div key={index} tw="flex-initial">
              ...
              >
                <div
                  ...
                  tw="inline-block transition-duration[0.15s] transition-timing-function[linear] lg:text-3xl bg-white hover:(bg-black border-2 border-white box-shadow[inset 0 0 10px white] border-solid rounded-full md:(p-5 text-5xl)) p-3 m-2 rounded"
                >
                  <item.icon />
                </div>
              </a>
